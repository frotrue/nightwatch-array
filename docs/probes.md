...
| `module_inventory_test.gd` | `MODULE_INVENTORY_PASS` | Fourteen entries, categories, ownership, acquisition routes, scroll/focus controls, keyboard tooltip anchors and pointer/focus handoff |
