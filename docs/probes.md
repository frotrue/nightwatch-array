...
actions and their saved state, the eight-second procedural coda and two-second
skip boundary, keyboard focus, save-failure retry, active-final-watch
resume/signature validation, corrupt-slot recovery, the non-destructive
