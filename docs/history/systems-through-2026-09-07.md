# systems reference before the 2026-09-07 cleanup

Historical reference copied from dddeda856bb11814e6e9839ff18b7d44135c3f36, docs/systems.md.
Original Git blob: ffc22b4f69b8a0f8d2073a2cdd799f6afd7ab177. The original block is byte-preserved.
Use the [current reference](../systems.md) and [archive index](README.md) for navigation.
Relative links inside the original block retain their original docs/ base directory.
Old implementation descriptions and test counts are not current requirements.
