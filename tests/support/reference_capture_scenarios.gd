...
const SCENARIOS := [
	...
	{"id": "deep_sky_chart", "stage": "chart_continuation", "density": "first_branch", "overlays": ["chart", "constellation_inspector"], "note": "A completed save opens thirteen outer constellations on the original chart. Sixty-six research stars share its canvas and inspector; retired nodes remain invisible.", "expected": {"meteors": 0, "installed": 95, "tracking": false, "span": 1.0}},
