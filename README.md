...
같은 하늘의 M31 첫 관측으로 후속 연구가 열리며, 계획·표본 분석은 성도의 보조 기능이다.
모듈 14종을 연구·구매·표본 분석으로 얻고 연구탭의 편성 팝업에서 장착한다.
처음 2자리에서 최대 5자리로 확장한다. 7개 계획/18개 관측장과 현재 값은
[M31 확장 설계](docs/expansion-design.md)에 있다.
