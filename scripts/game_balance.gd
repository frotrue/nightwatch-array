...
const UPGRADE_NODES: Array[Dictionary] = [
	...
	},
	{
		...
		"hidden_until": [], "effect_type": "unlock", "effect_parameters": {"survey_distance": 460.0, "survey_probability": 0.30},
	...
	},
	{
		...
		"hidden_until": [], "effect_type": "transformation", "effect_parameters": {"echo_probability": 0.10},
		"major": false
	},
	{
	...
	},
	{
		...
		"branch": "gemini", "prerequisites": [],
		"hidden_until": [], "effect_type": "unlock", "effect_parameters": {"echo_count": 1},
		"major": false
	},
	{
	...
	},
	{
		...
		"branch": "leo", "prerequisites": ["leonid_radiant"],
		"hidden_until": ["leonid_radiant"], "effect_type": "transformation", "effect_parameters": {"storm_radiants": 2},
		"major": false, "affects_pacing": false
	},
	{
		...
		"hidden_until": ["split_radiant_model"], "effect_type": "discovery", "effect_parameters": {"storm_lead_type": "fragment"},
		"major": true, "affects_pacing": false
	},
	{
	...
	},
	{
		...
		"hidden_until": ["echo_signature_lock"], "effect_type": "transformation", "effect_parameters": {"mirror_echo_path": true},
		"major": true, "affects_pacing": false
	},
	{
	...
	},
	{
		...
		"hidden_until": ["triple_echo_array"], "effect_type": "automation", "effect_parameters": {"echo_deconfliction": true},
		"major": true, "affects_pacing": false
	},
	{
		...
		"branch": "gemini", "prerequisites": ["triple_echo_array"],
		"hidden_until": ["triple_echo_array"], "effect_type": "unlock", "effect_parameters": {"echo_forecast": true},
		"major": true, "affects_pacing": false
	},
	{
		...
		"hidden_until": [], "effect_type": "unlock", "effect_parameters": {"combo_window": 3.0, "combo_cap": 4, "speed_per_stack": 0.02, "radius_per_stack": 1.0},
		"major": false, "affects_pacing": false
	},
	{
