...
func meteor_screen_scale() -> float:
	# Camera feedback generated by a meteor should recede with the object rather
	# than retaining opening-stage pixel force. The visual is drawn in world
	# units and then camera-scaled, yielding 1 / sqrt(span) on screen.
