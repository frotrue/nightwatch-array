...
const RESEARCH := {
	...
	"ext_sge_cadence": {"cost": 60000000.0, "requires": ["ext_protocol"], "branch": "sagitta", "effects": {}},
	"ext_sge_forecast": {"cost": 120000000.0, "requires": ["ext_sge_cadence"], "branch": "sagitta", "effects": {"asteroid_spawn": 1.35}},
	"ext_sge_solution": {"cost": 180000000.0, "requires": ["ext_sge_forecast"], "branch": "sagitta", "effects": {}},
	"ext_sge_window": {"cost": 180000000.0, "requires": ["ext_sge_cadence"], "branch": "sagitta", "effects": {"asteroid_speed": 1.3}},
	"ext_sge_stream": {"cost": 300000000.0, "requires": ["ext_sge_solution", "ext_sge_window"], "branch": "sagitta", "effects": {"asteroid_value": 1.5}},
	...
	"ext_cnc_planet": {"cost": 240000000.0, "requires": ["ext_sge_solution"], "branch": "cancer", "effects": {}},
	"ext_cnc_arrivals": {"cost": 300000000.0, "requires": ["ext_cnc_planet"], "branch": "cancer", "effects": {"planet_spawn": 1.35}},
	"ext_cnc_tracking": {"cost": 360000000.0, "requires": ["ext_cnc_planet"], "branch": "cancer", "effects": {"planet_speed": 1.3}},
	"ext_cnc_yield": {"cost": 480000000.0, "requires": ["ext_cnc_tracking"], "branch": "cancer", "effects": {"planet_value": 1.5}},
	"ext_cnc_survey": {"cost": 600000000.0, "requires": ["ext_cnc_arrivals", "ext_cnc_yield"], "branch": "cancer", "effects": {"planet_spawn": 1.3, "planet_value": 1.3}},
	"ext_sgr_black_hole": {"cost": 480000000.0, "requires": ["ext_cnc_tracking"], "branch": "sagittarius", "effects": {}},
	"ext_sgr_reach": {"cost": 360000000.0, "requires": ["ext_sgr_black_hole"], "branch": "sagittarius", "effects": {"gravity_radius": 1.25}},
	"ext_sgr_hold": {"cost": 480000000.0, "requires": ["ext_sgr_reach"], "branch": "sagittarius", "effects": {"gravity_slow_seconds": 1.0}},
	"ext_sgr_tracking": {"cost": 360000000.0, "requires": ["ext_sgr_black_hole"], "branch": "sagittarius", "effects": {"black_hole_speed": 1.3}},
	"ext_sgr_yield": {"cost": 480000000.0, "requires": ["ext_sgr_tracking"], "branch": "sagittarius", "effects": {"black_hole_value": 1.5}},
	"ext_sgr_arrivals": {"cost": 600000000.0, "requires": ["ext_sgr_yield"], "branch": "sagittarius", "effects": {"black_hole_spawn": 1.35}},
	"ext_sgr_wide": {"cost": 600000000.0, "requires": ["ext_sgr_hold"], "branch": "sagittarius", "effects": {"gravity_radius": 1.2}},
	"ext_sgr_linger": {"cost": 720000000.0, "requires": ["ext_sgr_wide", "ext_sgr_arrivals"], "branch": "sagittarius", "effects": {"gravity_slow_seconds": 1.0}},
}
