...
const RESEARCH := {
	...
	"ext_aql_stream": {"cost": 300000000.0, "requires": ["ext_aql_pair", "ext_aql_stride"], "branch": "aquila", "effects": {"survey_cooldown": 0.85}},
	"ext_vul_memory": {"cost": 60000000.0, "requires": ["ext_protocol"], "branch": "vulpecula", "effects": {"combo_window": 1.0}},
	"ext_vul_rhythm": {"cost": 120000000.0, "requires": ["ext_vul_memory"], "branch": "vulpecula", "effects": {"combo_speed": 0.005}},
	"ext_vul_arc": {"cost": 180000000.0, "requires": ["ext_vul_memory"], "branch": "vulpecula", "effects": {"combo_radius": 0.3}},
	"ext_vul_cadence": {"cost": 240000000.0, "requires": ["ext_vul_rhythm", "ext_vul_arc"], "branch": "vulpecula", "effects": {"combo_cap": 2}},
	"ext_vul_flow": {"cost": 300000000.0, "requires": ["ext_vul_cadence"], "branch": "vulpecula", "effects": {"combo_window": 1.0, "combo_speed": 0.005}},
	...
	"ext_sge_forecast": {"cost": 120000000.0, "requires": ["ext_sge_cadence"], "branch": "sagitta", "effects": {"forecast_lead": 0.6}},
	"ext_sge_solution": {"cost": 180000000.0, "requires": ["ext_sge_forecast"], "branch": "sagitta", "effects": {"forecast_error": 0.85}},
